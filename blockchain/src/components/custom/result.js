...
class result extends Component {
    ...
    render(){
        this.state.candidates.map(candidates => {
            ...
            if(candidates.voteCount>this.state.max){
               this.setState({
    ...
    console.log(this.state.max_cand+"hii");
        ...
        return(
            <div className="container">
                <ul className="collection">
                    ...
                    <div className="contact" key={this.state.max_cand.id}>
                    <li className="collection-item avatar">
                        <i className="material-icons circle blue darken-2">ballot</i>
                        <p><b>{this.state.max_cand.name}</b></p>
                        <p>{this.state.max_cand.details}</p>
                        <p className="secondary-content"><b>{this.state.max_cand.voteCount}</b></p>
                    </li>
                </div>
                </ul>
            </div>
