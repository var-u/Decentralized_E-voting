        ...
        return (
            <div className="container">
                ...
                <li className="collection-header"><h3>Choose User Type</h3></li>
                    <li className="collection-item"><div><h4>User<Link to="/userLogin" className="secondary-content"><i className="material-icons" style={{color:"#1976D2"}}>send</i></Link></h4></div></li>
